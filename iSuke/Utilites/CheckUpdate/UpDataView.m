...
- (void)confignUI{
    ...
    [contentView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(235);
        make.height.mas_equalTo([self->_content boundingRectWithSize:CGSizeMake(contentLabel.frame.size.width, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize: 14]} context:nil].size.height + 290);
    }];
